...
if($_SERVER["REQUEST_METHOD"] == "POST" && $_POST["submit"] <> '' && (!isset($_POST["PARAMS_HASH"]) || $arResult["PARAMS_HASH"] === $_POST["PARAMS_HASH"]))
{
	...
	if(check_bitrix_sessid())
	{
		...
		if(empty($arResult["ERROR_MESSAGE"]))
		{
			...
			$_SESSION["MF_COMPANI"] = htmlspecialcharsbx($_POST["user_compani"]);
			$_SESSION["MF_PHONE"] = htmlspecialcharsbx($_POST["user_phone"]);
			$_SESSION["MF_AGE"] = htmlspecialcharsbx($_POST["user_age"]);
		...
		$arResult["COMPANI"] = htmlspecialcharsbx($_POST["user_compani"]);
		$arResult["AUTHOR_EMAIL"] = htmlspecialcharsbx($_POST["user_email"]);
		$arResult["AUTHOR_PHONE"] = htmlspecialcharsbx($_POST["user_phone"]);
		$arResult["AGE"] = htmlspecialcharsbx($_POST["user_age"]);
	}
	else
